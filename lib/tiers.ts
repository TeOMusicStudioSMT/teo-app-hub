...
export const MODULE_PILLAR: Record<string, 1 | 2 | 3> = {
  ...
  dashboard: 1, projects: 1, identity: 1, profile: 1, academy: 1, trust: 1, pralka: 1, kompas: 1, swiat: 1, telefon: 1, // Filar I — dla wszystkich (trust=start, pralka=sumienie, kompas=mapa gry)
  'teo-market': 2, 'field-control': 2, cobots: 2, teolab: 2, robotics: 2, kancelaria: 2, // Filar II — środkowy (kreacja, TeO Lab, Robotics, Kancelaria); Game Forge przeniesiony do Games Studio 2026-09-11
